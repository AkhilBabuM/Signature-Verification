...
from SOURCE.yolo_files.utils.general import check_img_size, non_max_suppression, scale_coords, set_logging
from SOURCE.yolo_files.utils.torch_utils import select_device, time_synchronized
